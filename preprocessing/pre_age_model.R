...
#types<-c("numeric,numeric","numeric")
...
agedepth<-merge(correctdepths_1,ages_final,by="Depth")###FILE TO BE USED TO MERGE WITH OTHERS except itrax
...
#ages_final_ITRAX<-read.table("C:/Users/Maria Jose Rivera/OneDrive - James Cook University/Australia renamed/Sanamere/Thesis Sections/PhD/experiments/exp_radiocarbon/data/Bacon_runs/SAN8_2019_16/SAN8_2019_16_35_ages.txt",skip=1)
